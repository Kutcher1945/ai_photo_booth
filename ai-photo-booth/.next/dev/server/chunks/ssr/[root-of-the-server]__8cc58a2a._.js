...
;
const metadata = {
    title: 'Photo Booth Pro Web | Professional Photo Capture',
    description: 'Modern web photo booth with professional filters, effects, and instant sharing capabilities',
    generator: 'v0.app',
    icons: {
        icon: [
            {
